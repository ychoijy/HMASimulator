...
##################### terminal settings ##################
set size ratio 0.5
set term postscript eps enhanced color font "Times-Roman, 10" size 3.5,2.0
...
set key font "Times-Roman, 10" spacing 1.5
#set nokey
...
##################### plot ###############################
set output "access_pattern.eps"
plot "access_pattern.dat" every 100 u 1:2 with point pt 0 ps 1 lt 3 title "Write", "access_pattern.dat" every 100 u 1:3 with point pt 0 ps 1 lt 1 title "Read"
