...
##################### terminal settings ##################
set size ratio 0.5
set term postscript eps enhanced color font "Times-Roman, 20" size 3.5,2.0
...
##################### legend #############################
#set key 0.01,100
set key outside horizontal top right box ls 20
set key font "Times-Roman, 10" spacing 0.5
#set nokey
